...
const ProfilesetupphotomodalThreeModal = (props) => {
  const navigate = useNavigate();

  function handleNavigate3() {
    navigate("/profilesetupphotoaddedthree");
  }
          ...
          <Column className="bg-white_A700 border border-gray_200 border-solid items-center justify-start lg:p-[113px] xl:p-[141px] 2xl:p-[159px] 3xl:p-[190px] rounded-radius8 w-[100%]">
            ...
            <Column className="items-center justify-start lg:p-[17px] xl:p-[21px] 2xl:p-[24px] 3xl:p-[28px] w-[35%]">
              <Column className="items-center justify-start w-[67%]">
                <Stack className="lg:h-[167px] xl:h-[209px] 2xl:h-[235px] 3xl:h-[281px] lg:w-[166px] xl:w-[208px] 2xl:w-[234px] 3xl:w-[280px]">
                  <Img
                    src="images/img_screenshot202.png"
                    className="absolute lg:h-[121px] xl:h-[151px] 2xl:h-[170px] 3xl:h-[203px] inset-y-[14%] w-[100%]"
                    alt="ScreenShot202"
                  />
                  <div className="absolute bg-black_900_a3 lg:h-[167px] xl:h-[209px] 2xl:h-[235px] 3xl:h-[281px] lg:w-[166px] xl:w-[208px] 2xl:w-[234px] 3xl:w-[280px]"></div>
                </Stack>
                <Img
...
export { ProfilesetupphotomodalThreeModal };
