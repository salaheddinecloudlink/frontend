...
const CalendaravailabilitymodalupdateavailabilityOneModal = (props) => {
  return (
    <>
      <ModalProvider
        ...
        <div className="m-[auto] max-h-[97vh] overflow-y-auto">
          <Column className="bg-white_A700 border border-gray_200 border-solid items-center justify-start lg:p-[192px] xl:p-[240px] 2xl:p-[270px] 3xl:p-[324px] rounded-radius8 w-[100%]">
            ...
            <Column className="justify-end lg:p-[16px] xl:p-[20px] 2xl:p-[23px] 3xl:p-[27px] w-[68%]">
              ...
              <Row className="items-center ml-[1px] mr-[auto] lg:mt-[16px] xl:mt-[20px] 2xl:mt-[23px] 3xl:mt-[27px] w-[29%]">
                <Text
              ...
              <Row className="items-center ml-[1px] mr-[auto] lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[25%]">
                <Text
                  className="font-bold text-bluegray_500 w-[auto]"
                  as="h3"
                  variant="h3"
...
export { CalendaravailabilitymodalupdateavailabilityOneModal };
