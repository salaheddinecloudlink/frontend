...
const CalendaravailabilitymodalextendavailabilityunselectedModal = (props) => {
  const navigate = useNavigate();

  function handleNavigate18() {
    navigate("/calendaravailabilitymodalextendavailabilitystartselected");
  }
                  ...
                  <Column className="items-center justify-start lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] w-[100%]">
                    ...
                    <Row className="items-center justify-evenly p-[4px] w-[100%]">
                      <Row className="items-center justify-between rounded-radius8 w-[41%]">
                        ...
                        <Column className="lg:h-[29px] xl:h-[36px] 2xl:h-[41px] 3xl:h-[49px] items-center xl:px-[10px] 2xl:px-[12px] 3xl:px-[14px] lg:px-[8px] rounded-radius8 lg:w-[28px] xl:w-[35px] 2xl:w-[40px] 3xl:w-[48px]">
                          <Text className="Eighteen" as="h3" variant="h3">
                            16
                          </Text>
                        </Column>
...
export { CalendaravailabilitymodalextendavailabilityunselectedModal };
