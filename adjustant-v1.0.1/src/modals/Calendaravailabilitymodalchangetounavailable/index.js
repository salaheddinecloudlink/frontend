...
const CalendaravailabilitymodalchangetounavailableModal = (props) => {
  return (
    <>
      <ModalProvider
      ...
      >
        <div className="m-[auto] max-h-[97vh] overflow-y-auto">
          <Column className="bg-white_A700 border border-gray_200 border-solid items-center justify-start lg:p-[198px] xl:p-[248px] 2xl:p-[279px] 3xl:p-[334px] rounded-radius8 w-[100%]">
            ...
            <Column className="justify-end lg:p-[17px] xl:p-[21px] 2xl:p-[24px] 3xl:p-[28px] w-[69%]">
              <Text className="DenverCO" as="h3" variant="h3">
                Sunday, Aug. 14, 2022 is currently set to available. Would you
                like to change it to be unavailable?
              </Text>
              <Line className="bg-gray_200 h-[1px] lg:mt-[19px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[32px] w-[100%]" />
              <Row className="bg-white_A700 items-center justify-end lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] 2xl:pl-[102px] 3xl:pl-[122px] lg:pl-[72px] xl:pl-[90px] w-[100%]">
                <Row className="items-center justify-center w-[42%]">
                  <Text
                ...
                <Button
                  className="2xl:ml-[24px] 3xl:ml-[28px] flex items-center justify-center lg:ml-[17px] text-center w-[47%] xl:ml-[21px]"
                  rightIcon={
                    <Img
...
export { CalendaravailabilitymodalchangetounavailableModal };
