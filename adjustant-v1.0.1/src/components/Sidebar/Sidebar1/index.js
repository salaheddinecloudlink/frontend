            ...
            <Column className="items-center justify-start xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] w-[100%]">
              ...
              <Column className="bg-white_A700 border border-gray_200 border-solid justify-start xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] lg:p-[17px] xl:p-[21px] 2xl:p-[24px] 3xl:p-[28px] rounded-radius8 w-[100%]">
                <Row className="items-center justify-between w-[100%]">
                  <Text
                    className="font-bold font-metropolis text-bluegray_100 w-[auto]"
                    as="h3"
                    variant="h3"
                  >
                  ...
                  <Button
                    className="font-medium font-metropolis xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-center w-[29%]"
                    shape="RoundedBorder8"
                    size="sm"
                ...
                <Row className="items-center xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] pt-[1px] w-[51%]">
                  <Row className="items-start justify-evenly w-[56%]">
                    <Img
                      ...
                      alt="location Three"
                    />
                    <Text className="location2" as="h3" variant="h3">
                      Boulder, CO
                    </Text>
                  </Row>
                  <Row className="items-start justify-evenly xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] lg:ml-[8px] w-[37%]">
                ...
                <Button
                  className="font-medium font-metropolis lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-center w-[14%]"
                  shape="RoundedBorder8"
                  size="sm"
                  variant="FillGray50"
                >
              ...
              <Row className="bg-bluegray_500 border border-solid border-white_A700_cc items-center justify-center lg:mb-[34px] xl:mb-[43px] 2xl:mb-[49px] 3xl:mb-[58px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] rounded-radius4 w-[100%]">
