...
const sizes = {
  sm: "pb-[10px] 3xl:pb-[12px] lg:pb-[7px] xl:pb-[8px] lg:pt-[4px] xl:pt-[6px] pt-[7px] 3xl:pt-[8px] lg:px-[4px] xl:px-[6px] px-[7px] 3xl:px-[8px]",
};
        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              backgroundColor: state.isSelected && "#1e488488",
              "&:hover": { backgroundColor: "#1e488488", color: "#478488" },
            }),
