...
const ProfilesetupdetailsThreePage = () => {
  const navigate = useNavigate();

  function handleNavigate1() {
    navigate("/profilesetupphotomodaltwo");
  }
  function handleNavigate2() {
    navigate("/profilepostsetupdefaulttwo");
  }
          ...
          <Column className="items-center justify-start mt-[1px] w-[49%]">
            ...
            <Column className="justify-start lg:mt-[37px] xl:mt-[47px] 2xl:mt-[53px] 3xl:mt-[63px] w-[100%]">
              <Column className="justify-start w-[38%]">
                ...
                <Button
                  className="2xl:mt-[12px] 3xl:mt-[14px] flex items-center justify-center lg:mt-[8px] text-center w-[56%] xl:mt-[10px]"
...
export default ProfilesetupdetailsThreePage;
