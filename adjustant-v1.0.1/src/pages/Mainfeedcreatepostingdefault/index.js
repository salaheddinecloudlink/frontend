...
const MainfeedcreatepostingdefaultPage = () => {
  return (
    <>
      <Column className="bg-gray_50 font-metropolis items-center justify-start mx-[auto] w-[100%]">
        ...
        <Column className="items-center justify-start lg:p-[17px] xl:p-[21px] 2xl:p-[24px] 3xl:p-[28px] w-[100%]">
          ...
          <Column className="bg-white_A700 border border-gray_200 border-solid justify-start 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[8px] lg:p-[32px] xl:p-[40px] 2xl:p-[46px] 3xl:p-[55px] rounded-radius8 w-[47%]">
            <Column className="justify-start ml-[1px] w-[73%]">
              <Text
                className="font-normal text-gray_600 w-[auto]"
                as="h2"
                variant="h2"
            ...
            <Input
              ...
              name="inputarea"
              placeholder="Where does this job take place?"
            ></Input>
          </Column>
          ...
          <Column className="bg-white_A700 border border-gray_200 border-solid justify-start 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[8px] lg:p-[34px] xl:p-[42px] 2xl:p-[48px] 3xl:p-[57px] rounded-radius8 w-[47%]">
            ...
            <Row className="items-center lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[69%]">
              <Button
                className="font-medium xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-center w-[15%]"
                shape="RoundedBorder8"
                size="sm"
                variant="OutlineBluegray500cc"
              >
              ...
              <Button
                className="font-medium lg:ml-[17px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-center w-[29%]"
                shape="RoundedBorder8"
                size="sm"
                variant="OutlineBluegray500cc"
              >
              ...
              <Button
                className="font-medium lg:ml-[17px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-center w-[23%]"
                shape="RoundedBorder8"
                size="sm"
                variant="OutlineBluegray500cc"
              >
              ...
              <Button
                className="font-medium lg:ml-[17px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-center w-[14%]"
                shape="RoundedBorder8"
                size="sm"
                variant="OutlineBluegray500cc"
              >
          ...
          <Column className="bg-white_A700 border border-gray_200 border-solid justify-start lg:mb-[17px] xl:mb-[21px] 2xl:mb-[24px] 3xl:mb-[28px] 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[8px] lg:p-[34px] xl:p-[42px] 2xl:p-[48px] 3xl:p-[57px] rounded-radius8 w-[47%]">
            <Column className="justify-start w-[84%]">
              ...
              <Text className="DHSLicense" as="h3" variant="h3">
                Would you like to post this job now or set a future date for it
                to be posted?
              </Text>
            </Column>
            <Row className="items-center lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[42%]">
              <Button
                className="font-medium xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-center w-[34%]"
                shape="RoundedBorder8"
                size="sm"
                variant="OutlineBluegray500cc"
              >
              ...
              <Button
                className="font-medium lg:ml-[17px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] lg:text-[9px] text-center w-[56%]"
                shape="RoundedBorder8"
                size="sm"
                variant="OutlineBluegray500cc"
              >
...
export default MainfeedcreatepostingdefaultPage;
