...
const CalendarunpopulateddefaultOnePage = () => {
              ...
              <React.Fragment key={Math.random()}>
                <Column className="bg-white_A700 items-center justify-start w-[100%]">
                  <Column className="justify-end lg:pt-[17px] xl:pt-[22px] 2xl:pt-[25px] 3xl:pt-[30px] w-[96%]">
                    ...
                    <Row className="items-center lg:ml-[34px] xl:ml-[42px] 2xl:ml-[48px] 3xl:ml-[57px] mr-[auto] w-[82%]">
                      <div className="bg-gray_200 lg:h-[18px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] w-[1px]"></div>
                      <div className="bg-gray_200 lg:h-[18px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] lg:ml-[106px] xl:ml-[133px] 2xl:ml-[150px] 3xl:ml-[180px] w-[1px]"></div>
                      <div className="bg-gray_200 lg:h-[18px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] lg:ml-[106px] xl:ml-[133px] 2xl:ml-[150px] 3xl:ml-[180px] w-[1px]"></div>
                      <div className="bg-gray_200 lg:h-[18px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] lg:ml-[106px] xl:ml-[133px] 2xl:ml-[150px] 3xl:ml-[180px] w-[1px]"></div>
                      <div className="bg-gray_200 lg:h-[18px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] lg:ml-[106px] xl:ml-[133px] 2xl:ml-[150px] 3xl:ml-[180px] w-[1px]"></div>
                      <div className="bg-gray_200 lg:h-[18px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] lg:ml-[106px] xl:ml-[133px] 2xl:ml-[150px] 3xl:ml-[180px] w-[1px]"></div>
...
export default CalendarunpopulateddefaultOnePage;
