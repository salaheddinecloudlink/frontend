...
const ProfilesetuplicensescertificationsPage = () => {
  const navigate = useNavigate();

  function handleNavigate29() {
    navigate("/profilesetupintro");
  }
  function handleNavigate30() {
    navigate("/profilesetuppreferences");
  }
...
export default ProfilesetuplicensescertificationsPage;
