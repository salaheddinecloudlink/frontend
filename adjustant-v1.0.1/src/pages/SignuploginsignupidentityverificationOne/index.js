...
const SignuploginsignupidentityverificationOnePage = () => {
  const navigate = useNavigate();

  function handleNavigate28() {
    navigate("/signuploginsignupcreatepasswordone");
  }
...
export default SignuploginsignupidentityverificationOnePage;
