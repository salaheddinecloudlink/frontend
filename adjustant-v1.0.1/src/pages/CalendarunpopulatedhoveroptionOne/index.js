...
const CalendarunpopulatedhoveroptionOnePage = () => {
  const sliderRef = React.useRef();
  const [sliderState, setsliderState] = React.useState(0);

  return (
    <>
      <Column className="bg-white_A700 font-metropolis items-center justify-start mx-[auto] w-[100%]">
        ...
        <Stack className="lg:h-[528px] xl:h-[661px] 2xl:h-[743px] 3xl:h-[891px] mt-[1px] w-[98%]">
          <Sidebar2 className="absolute left-[0] w-[19%]" />
          <Column className="absolute bg-gray_50 bottom-[0] justify-start lg:px-[17px] xl:px-[21px] 2xl:px-[24px] 3xl:px-[28px] right-[0] w-[81%]">
            ...
            items={[...Array(15)].map(() => (
              <React.Fragment key={Math.random()}>
                <Column className="bg-white_A700 items-center justify-start w-[100%]">
                  <Column className="justify-end lg:pt-[17px] xl:pt-[22px] 2xl:pt-[25px] 3xl:pt-[30px] w-[96%]">
                    <Row className="items-center justify-center mx-[auto] w-[34%]">
                      <Button
                    ...
                    <Row className="items-center lg:ml-[34px] xl:ml-[42px] 2xl:ml-[48px] 3xl:ml-[57px] mr-[auto] rounded-radius8 w-[82%]">
                      <Line className="bg-gray_200 lg:h-[18px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] w-[1px]" />
                      <Row className="bg-bluegray_500_1e items-start p-[4px] rounded-bl-[0] rounded-br-[0] rounded-tl-[4px] rounded-tr-[4px] w-[17%]">
                        <Img
                          src="images/img_plus_10X10.svg"
                          className="plus4"
                          alt="plus"
                        />
                        <Text className="addhover" as="h5" variant="h5">
                          Add Availability
                        </Text>
                      </Row>
                      <Line className="bg-gray_200 lg:h-[18px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] w-[1px]" />
                      <Line className="bg-gray_200 lg:h-[18px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] lg:ml-[106px] xl:ml-[133px] 2xl:ml-[150px] 3xl:ml-[180px] w-[1px]" />
                      <Line className="bg-gray_200 lg:h-[18px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] lg:ml-[106px] xl:ml-[133px] 2xl:ml-[150px] 3xl:ml-[180px] w-[1px]" />
                      <Line className="bg-gray_200 lg:h-[18px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] lg:ml-[106px] xl:ml-[133px] 2xl:ml-[150px] 3xl:ml-[180px] w-[1px]" />
                      <Line className="bg-gray_200 lg:h-[18px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] lg:ml-[106px] xl:ml-[133px] 2xl:ml-[150px] 3xl:ml-[180px] w-[1px]" />
                      <Line className="bg-gray_200 lg:h-[18px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] lg:ml-[106px] xl:ml-[133px] 2xl:ml-[150px] 3xl:ml-[180px] w-[1px]" />
...
export default CalendarunpopulatedhoveroptionOnePage;
