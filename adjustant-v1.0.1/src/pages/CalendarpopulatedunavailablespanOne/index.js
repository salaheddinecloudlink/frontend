...
const CalendarpopulatedunavailablespanOnePage = () => {
    ...
    <>
      <Column className="bg-white_A700 font-metropolis items-center justify-end mx-[auto] w-[100%]">
        ...
        <Stack className="lg:h-[1304px] xl:h-[1631px] 2xl:h-[1835px] 3xl:h-[2201px] mt-[1px] w-[98%]">
              ...
              <React.Fragment key={Math.random()}>
                <Column className="bg-white_A700 items-center justify-start w-[100%]">
                  <Column className="justify-end lg:pt-[17px] xl:pt-[22px] 2xl:pt-[25px] 3xl:pt-[30px] w-[96%]">
                    ...
                    <List
                      className="gap-[1px] grid grid-cols-[repeat(3,_1fr_1px)_1fr] min-h-[auto] lg:ml-[34px] xl:ml-[42px] 2xl:ml-[48px] 3xl:ml-[57px] lg:mr-[106px] xl:mr-[133px] 2xl:mr-[150px] 3xl:mr-[180px] px-[1px] rounded-radius8 w-[82%]"
                      orientation="horizontal"
                    >
                      <Row className="bottomdividers">
                        <Img
                          src="images/img_bag.svg"
                          className="plus4"
                          alt="bag"
                        />
                        <Text className="status" as="h5" variant="h5">
                          Unavailable
                        </Text>
                      </Row>
                      <Line className="self-center w-[1px] bg-gray_200 lg:h-[18px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px]" />
                      <Row className="justify-center bottomdividers">
                        <Img
                          src="images/img_bag.svg"
                          className="plus4"
                          alt="bag One"
                        />
                        <Text className="status1" as="h5" variant="h5">
                          Unavailable
                        </Text>
                      </Row>
                      <Line className="self-center w-[1px] bg-gray_200 lg:h-[18px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px]" />
          ...
          />
          <div className="bg-black_900_14 unavailableblo"></div>
          <div className="bg-black_900_14 unavailableblo_One"></div>
          <div className="bg-black_900_14 unavailableblo_Two"></div>
          <div className="bg-black_900_14 unavailableblo_Three"></div>
        </Stack>
      </Column>
    </>
  );
...
export default CalendarpopulatedunavailablespanOnePage;
